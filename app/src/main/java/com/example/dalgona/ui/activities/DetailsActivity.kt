...
import com.example.dalgona.adapters.PagerAdapter
import com.example.dalgona.data.database.entities.FavoritesEntity
import com.example.dalgona.databinding.ActivityDetailsBinding
import com.example.dalgona.ui.fragments.veiwPagerFragments.IngredientsFragment
import com.example.dalgona.ui.fragments.veiwPagerFragments.InstructionsFragment
import com.example.dalgona.ui.fragments.veiwPagerFragments.OverviewFragment
...
//            binding.viewPager2.isUserInputEnabled = false           //to prevent scroll feature.
    ...
    private fun saveToFavorites(item: MenuItem) {
        val favoritesEntity = args.result?.let {
            FavoritesEntity(
                savedRecipeId,
                it
            )
